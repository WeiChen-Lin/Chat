      ...
      <a className="flex flex-col px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
        <div className="flex items-center">
          <img
            ...
            alt="username"
          />
          <div className="block ml-2 text-base font-semibold text-gray-600">{props.name}</div>
        </div>
        <div className="ml-10 px-2 w-4/5 break-words">{props.introduction}</div>
      </a>
    </li>
  );
}

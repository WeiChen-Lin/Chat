...
const DefaultIntro = () => {
  return <p className="text-gray-400 italic">This user has not introduced himself yet ...</p>;
};
...
export { DefaultIntro, LoadingIcon, ReplyIcon, DefaultIcon, WaitingIcon, SuccessIcon };
